...
// Shared full-page notifications feed (web#11). Rendered by both the admin
// page /d/notifications and the doctor page /w/notifications; each page
// supplies its own DashboardHeader. Mirrors the bell popover list.
